...
import urllib
import modules.cfg
import modules.prefs
import modules.crypt_interface
...
class Pyrite:
    ...
    def set_defaults_from_prefs(self, startup=False):
        ...
        if startup:
            ...
            self.g_msgtxtview.modify_base(
                Gtk.STATE_NORMAL, Gdk.color_parse(self.p['color_bg']))
            self.g_msgtxtview.modify_text(
                Gtk.STATE_NORMAL, Gdk.color_parse(self.p['color_fg']))
    ...
    def fix_msgtxtviewcolor(self, sensitive):
        ...
        if sensitive:
            ...
            self.g_msgtxtview.modify_text(
                Gtk.STATE_NORMAL, Gdk.color_parse('black'))
